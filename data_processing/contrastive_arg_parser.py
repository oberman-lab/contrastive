...
class ContrastiveArgParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        self.add_argument('--batch-size-labeled', type=int, default=8, metavar='NL',
                          help='input labeled batch size for training (default: 128)')

        self.add_argument('--batch-size-unlabeled', type=int, default=8, metavar='NU',
                          help='input unlabeled batch size for training (default: 128)')

        self.add_argument('--epochs', type=int, default=5, metavar='N',
                          help='number of epochs to train (default: 10)')
        self.add_argument('--lr', type=float, default=0.001, metavar='LR',
        ...
        self.add_argument('--frac-labeled', type=float, default=0.1, metavar='FL',
